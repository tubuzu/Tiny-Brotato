...
public class CameraFollow : MonoBehaviour
{
    ...
    void Follow()
    {
        ...
        if (distance < 4f)
            transform.position = smoothFollow ? Vector3.Lerp(transform.position, boundPosition, smoothFactor * Time.deltaTime) : boundPosition;
        else transform.position = boundPosition;
    }
